      ...
      .then(({ json: jsonLogin }) => {
        return frisby.get(REST_URL + '/order-history', {
          ...
          .then(({ json }) => {
            ...
            expect(json.data[0].products[0].name).toBe('Recon Energy Drink (1000ml)')
            ...
            expect(json.data[0].products[1].name).toBe('Brute-Force Booster (1000ml)')
            ...
            expect(json.data[1].products[0].name).toBe('Payload Punch (500ml)')
