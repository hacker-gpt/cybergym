    ...
    it('GET own previous orders', () => {
        return frisby.post(REST_URL + '/user/login', {
            ...
            return frisby.get(REST_URL + '/order-history', {
                ...
                (0, globals_1.expect)(json.data[0].products[0].name).toBe('Recon Energy Drink (1000ml)');
                ...
                (0, globals_1.expect)(json.data[0].products[1].name).toBe('Brute-Force Booster (1000ml)');
                ...
                (0, globals_1.expect)(json.data[1].products[0].name).toBe('Payload Punch (500ml)');
